    ...
    return (
        <div className='App-header'>
            <div style={{ border: '3px solid white', padding: 30, borderRadius: 15, backgroundColor:'#778899'}}>
                ...
                <button onClick={() => { navigate('SignInClient') }} style={{ margin: 10 }} type="button" class="btn btn-outline-light">אני עובד</button>
                <button onClick={() => { navigate('SignInWorker') }} type="button" class="btn btn-outline-light">אני מנהל</button>
            </div>
        </div>
